...
class translatorFull:
    ...
    def subI8(self, valueText, TXT_FILE,TXT_FILE2):
    ...
    def subI4(self, valueText, TXT_FILE,TXT_FILE2):

        # Ruta local al modelo NLLB-200-distilled-600M INT4
        local_model_path = os.path.abspath("../resources/nllb-200-distilled-600M-int4")
        tokenizer = AutoTokenizer.from_pretrained(local_model_path)
        model = OVModelForSeq2SeqLM.from_pretrained(local_model_path)
    ...
    def subOr(self, valueText, TXT_FILE, TXT_FILE2):

        # Ruta local al modelo NLLB-200-distilled-600M original
        local_model_path = os.path.abspath("../resources/nllb-200-distilled-600M")
        tokenizer = AutoTokenizer.from_pretrained(local_model_path)
